...
const ru: Record<TranslationKeys, string> = {
  ...
  comingSoon: 'Скоро',
  heroNow: 'Начни отсюда',
  groupDaily: 'Каждый день',
  groupDiscover: 'Открой для себя',
  heroLearnTitle: 'Разберись с основами',
  heroLearnBody: 'Короткие уроки расскажут, на чём работает Unisouq — Stars, TON, подарки и остальное.',
  heroLearnAction: 'Открыть уроки',
  heroWalletTitle: 'Привяжи TON-кошелёк',
  heroWalletBody: 'Подключи кошелёк, чтобы отправлять, получать и выводить TON прямо из Unisouq.',
  heroWalletAction: 'Перейти в кошелёк',
  heroGiftsTitle: 'Забери первый подарок',
  heroGiftsBody: 'Оригинальные NFT-подарки Unisouq — для профиля и обмена с друзьями.',
  heroGiftsAction: 'К подаркам',
  heroCodexTitle: 'Закрой Кодекс',
  heroCodexBody: 'Разблокируй оставшиеся карточки технологий и собери всю коллекцию.',
  heroCodexAction: 'Открыть Кодекс',
  heroCommunityTitle: 'Загляни в сообщество',
  heroCommunityBody: 'Публикуй посты, подписывайся на авторов и набирай репутацию в Unisouq.',
  heroCommunityAction: 'В сообщество',
  ...
  sectionFlows: 'Флоу',
  sectionFlowsDesc: 'Автоматизации для Telegram проекта',
  flowsCreate: 'Создать флоу',
  flowsEmpty: 'Флоу пока нет',
  flowsDraft: 'Черновик',
  flowsPublished: 'Опубликовано',
  flowsArchived: 'Архив',
  flowsPublish: 'Опубликовать',
  flowsArchive: 'В архив',
  flowsUntitled: 'Флоу без названия',
  flowsNamePlaceholder: 'Например: Триаж саппорта',
  flowsTrigger: 'Триггер',
  flowsTriggerCommand: 'Команда',
  flowsTriggerWebhook: 'Вебхук',
  flowsTriggerSchedule: 'Расписание',
  flowsTriggerStars: 'Оплата Stars',
  flowsTriggerLabel: 'Триггер: {trigger}',
  ...
  identity: 'Личность',
  walletNotLinked: 'Не привязан',
  walletLinkHint: 'Привяжи в Crypto \u2192 Wallet',
  xp: 'XP',
  codexProgress: 'Codex',
  giftsOwned: 'Подарки',
  myGifts: 'Мои подарки',
  myCodex: 'Codex',
  seeAll: 'Все',
  emptyGiftsShort: 'Подарков пока нет',
  emptyCodexShort: 'Карточки не открыты',
