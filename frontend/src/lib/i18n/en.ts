const en = {
  ...
  heroLearnTitle: 'Learn the ropes',
  heroLearnBody: 'A few short lessons cover everything Unisouq runs on — Stars, TON, gifts, and more.',
  heroLearnAction: 'Open Learn',
  heroWalletTitle: 'Link your TON wallet',
  heroWalletBody: 'Connect a wallet to send, receive, and withdraw TON directly from Unisouq.',
  heroWalletAction: 'Go to Wallet',
  heroGiftsTitle: 'Claim your first gift',
  heroGiftsBody: 'Original Unisouq NFT gifts to display on your profile and trade with friends.',
  heroGiftsAction: 'Browse gifts',
  heroCodexTitle: 'Finish your Codex',
  heroCodexBody: 'Unlock the remaining technology cards to complete the collection.',
  heroCodexAction: 'Open Codex',
  heroCommunityTitle: 'Step into Community',
  heroCommunityBody: 'Share posts, follow creators, and build reputation across Unisouq.',
  heroCommunityAction: 'Go to Community',
  ...
  sectionFlows: 'Flows',
  sectionFlowsDesc: 'Automations for your Telegram project',
  flowsCreate: 'Create flow',
  flowsEmpty: 'No flows yet',
  flowsDraft: 'Draft',
  flowsPublished: 'Published',
  flowsArchived: 'Archived',
  flowsPublish: 'Publish',
  flowsArchive: 'Archive',
  flowsUntitled: 'Untitled flow',
  flowsNamePlaceholder: 'Example: Support triage',
  flowsTrigger: 'Trigger',
  flowsTriggerCommand: 'Command',
  flowsTriggerWebhook: 'Webhook',
  flowsTriggerSchedule: 'Schedule',
  flowsTriggerStars: 'Stars payment',
  flowsTriggerLabel: 'Trigger: {trigger}',
